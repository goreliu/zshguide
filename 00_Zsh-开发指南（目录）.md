...
### [导读](23_Zsh-开发指南（第二十三篇-用-jq-命令处理-JSON-数据）.md#导读)
### [读取字段](23_Zsh-开发指南（第二十三篇-用-jq-命令处理-JSON-数据）.md#读取字段)
### [数组相关操作](23_Zsh-开发指南（第二十三篇-用-jq-命令处理-JSON-数据）.md#数组相关操作)
### [数组读取](23_Zsh-开发指南（第二十三篇-用-jq-命令处理-JSON-数据）.md#数组读取)
-  [数组相关函数](23_Zsh-开发指南（第二十三篇-用-jq-命令处理-JSON-数据）.md#数组相关函数)
-  [数组写入](23_Zsh-开发指南（第二十三篇-用-jq-命令处理-JSON-数据）.md#数组写入)
### [哈希表相关操作](23_Zsh-开发指南（第二十三篇-用-jq-命令处理-JSON-数据）.md#哈希表相关操作)
-  [哈希表读取](23_Zsh-开发指南（第二十三篇-用-jq-命令处理-JSON-数据）.md#哈希表读取)
-  [哈希表相关函数](23_Zsh-开发指南（第二十三篇-用-jq-命令处理-JSON-数据）.md#哈希表相关函数)
-  [哈希表写入](23_Zsh-开发指南（第二十三篇-用-jq-命令处理-JSON-数据）.md#哈希表写入)
### [内置运算](23_Zsh-开发指南（第二十三篇-用-jq-命令处理-JSON-数据）.md#内置运算)
### [变量](23_Zsh-开发指南（第二十三篇-用-jq-命令处理-JSON-数据）.md#变量)
### [总结](23_Zsh-开发指南（第二十三篇-用-jq-命令处理-JSON-数据）.md#总结)
### [参考](23_Zsh-开发指南（第二十三篇-用-jq-命令处理-JSON-数据）.md#参考)
